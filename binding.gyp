  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
                ...
                './deps/libgit2/src/allocators/failalloc.c',
                './deps/libgit2/src/allocators/failalloc.h',
                './deps/libgit2/src/hash.c',
                './deps/libgit2/src/fs_path.c',
                ...
                './deps/libgit2/src/CMakeLists.txt',
                './deps/libgit2/src/str.h',
                ...
                './deps/libgit2/src/config_entries.h',
                ...
                './deps/libgit2/src/transports/auth_ntlm.h',
                ...
                './deps/libgit2/src/transports/http.h',
                './deps/libgit2/src/transports/auth.c',
                './deps/libgit2/src/transports/smart.h',
                './deps/libgit2/src/transports/credential_helpers.c',
                './deps/libgit2/src/transports/auth.h',
                './deps/libgit2/src/transports/git.c',
                './deps/libgit2/src/transports/auth_ntlm.c',
                './deps/libgit2/src/transports/auth_negotiate.h',
                './deps/libgit2/src/transports/credential.c',
                './deps/libgit2/src/transports/ssh.h',
                './deps/libgit2/src/transports/httpclient.h',
                './deps/libgit2/src/zstream.h',
                './deps/libgit2/src/apply.h',
                './deps/libgit2/src/config_snapshot.c',
                './deps/libgit2/src/mwindow.h',
                './deps/libgit2/src/pathspec.c',
                './deps/libgit2/src/merge_driver.h',
                './deps/libgit2/src/midx.c',
                ...
                './deps/libgit2/src/streams/mbedtls.h',
                './deps/libgit2/src/streams/tls.c',
                './deps/libgit2/src/streams/openssl_dynamic.c',
                './deps/libgit2/src/streams/stransport.h',
                './deps/libgit2/src/streams/openssl_legacy.c',
                './deps/libgit2/src/streams/registry.h',
                './deps/libgit2/src/streams/openssl.h',
                './deps/libgit2/src/streams/openssl_legacy.h',
                './deps/libgit2/src/streams/registry.c',
                './deps/libgit2/src/streams/openssl_dynamic.h',
                './deps/libgit2/src/streams/tls.h',
                './deps/libgit2/src/streams/socket.h',
                ...
                './deps/libgit2/src/buf.c',
                './deps/libgit2/src/net.h',
                './deps/libgit2/src/status.c',
                './deps/libgit2/src/thread.c',
                './deps/libgit2/src/assert_safe.h',
                './deps/libgit2/src/diff_parse.h',
                './deps/libgit2/src/thread.h',
                ...
                './deps/libgit2/src/utf8.c',
                './deps/libgit2/src/commit_graph.c',
                ...
                './deps/libgit2/src/xdiff/git-xdiff.h',
                ...
                './deps/libgit2/src/threadstate.c',
                './deps/libgit2/src/regexp.c',
                './deps/libgit2/src/utf8.h',
                ...
                './deps/libgit2/src/features.h.in',
                './deps/libgit2/src/diff_driver.c',
                './deps/libgit2/src/vector.c',
                './deps/libgit2/src/libgit2.c',
                './deps/libgit2/src/stream.h',
                './deps/libgit2/src/date.h',
                './deps/libgit2/src/midx.h',
                './deps/libgit2/src/wildmatch.h',
                './deps/libgit2/src/futils.h',
                './deps/libgit2/src/settings.h',
                './deps/libgit2/src/regexp.h',
                './deps/libgit2/src/refdb.c',
                './deps/libgit2/src/rand.c',
                './deps/libgit2/src/libgit2.h',
                './deps/libgit2/src/merge.c',
                './deps/libgit2/src/sysdir.c',
                './deps/libgit2/src/reader.h',
                './deps/libgit2/src/sysdir.h',
                './deps/libgit2/src/threadstate.h',
                './deps/libgit2/src/patch_parse.c',
                './deps/libgit2/src/offmap.h',
                './deps/libgit2/src/blame_git.c',
                './deps/libgit2/src/str.c',
                ...
                './deps/libgit2/src/commit_graph.h',
      ...
      'conditions': [
        ...
        ['OS=="win"', {
          ...
          'sources': [
            './deps/libgit2/src/allocators/win32_leakcheck.h',
            './deps/libgit2/src/allocators/win32_leakcheck.c',
            ...
            './deps/libgit2/src/win32/w32_leakcheck.c',
            ...
            './deps/libgit2/src/win32/w32_common.h',
            './deps/libgit2/src/win32/utf-conv.c',
            './deps/libgit2/src/win32/w32_leakcheck.h',
            ...
            './deps/libgit2/src/hash/sha1/win32.c',
            './deps/libgit2/src/hash/sha1/win32.h'
          ],
        }, {
          'libraries': [
            '-lpthread',
          ...
          'sources': [
                      './deps/libgit2/src/unix/realpath.c',
                       ...
                       './deps/libgit2/src/unix/pthread.h',
                       './deps/libgit2/src/hash/sha1/generic.h',
                       './deps/libgit2/src/hash/sha1/generic.c'
          ],
          'cflags': [
            '-Wno-missing-field-initializers',
            '-Wno-unused-variable',
